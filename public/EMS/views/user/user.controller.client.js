...
(function () {
    ...
    function ProfileController($location, $routeParams, UserService, EventService) {
        ...
        vm.addFriendToUser = addFriendToUser;
        vm.cancelFriendRequest = cancelFriendRequest;

        function addFriendToUser(requesterId) {
            UserService
        ...
        function cancelFriendRequest(requesterId) {
            UserService
                                                ...
                                                .success(function (users) {
                                                    ...
                                                    EventService
                                                        ...
                                                        .success(function (events) {
                                                            ...
                                                            UserService
                                                                .findAllRequestsForUserById(currentUser._id)
                                                                .success(function (userObj) {
                                                                    var requests = userObj.friendRequests;
                                                                    vm.alreadyRequestedPending = false;
                                                                    for(var r in requests) {
                                                                        var req = requests[r];
                                                                        if(req.requestedUser == user._id.toString()) {
                                                                            vm.alreadyRequestedPending = true;
                                                                            break;
                                                                        }
                                                                    }
    ...
    function FriendListController($location, $routeParams, UserService) {
        ...
        function openUserProfile(username) {
            $location.url("/user_friend/"+username);
        }
    }
